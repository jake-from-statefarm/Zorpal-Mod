...
public class MyLootTables extends BaseLootTableProvider {
    ...
    protected void addTables() {
        ...
        lootTables.put(Registration.ZORPAL_ORE_DEEPSLATE.get(), createSilkTouchTable("zorpal_ore_deepslate", Registration.ZORPAL_ORE_DEEPSLATE.get(), Registration.RAW_ZORP.get(), 1, 2));
